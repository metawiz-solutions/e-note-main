  ...
  <div class="content">
    <div class="contentTwo">
      ...
      <div class="contentBox">
        <h3 style="color: black;">Content Will Update soon</h3>
      </div>
      <div class="contentButtons">
        <h2 style="color: black; font-weight: 600;">STUDENTS GET</h2>
        <button class="btn">SUBJECT <br> WISE NOTES</button>
        <button class="btn">SUMMARIZE <br> NOTES</button>
        <button class="btn">COMMUNICATION <br> PORTAL</button>
      </div>
    </div>
  </div>
